...
class NN:
    ...
    def backPropagate(self, targets, N, M):
        ...
        for k in range(self.no):
            ...
            # print "dsigmoid\t" + str(dsigmoid(self.ao[k]))
            # print "output_deltas[k]\t" + str(output_deltas[k])
        print "output_error\t" + str(output_deltas)
        ...
        # print self.ah[j]
        # print self.ah
        # print dsigmoid(self.ah[j])
        # print "hidden_error\t" + str(hidden_deltas)
...
def test():
    ...
    print n.ah
    print n.ao
    print len(n.wi),len(n.wi[0])
    print len(n.wo),len(n.wo[0])
    print dsigmoid(n.ao[0])


if __name__ == '__main__':
    demo()
    # test()
    # print makeMatrix(2,2,1)